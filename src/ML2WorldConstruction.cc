...
bool CML2WorldConstruction::create(SInputData *inputData, bool bOV)
{
  ...
  /*  G4double pdx1 = 45.*mm;
    ...
    G4LogicalVolume * ConeLV = new G4LogicalVolume(subtract, Vac, "ConeLV", 0, 0, 0);
    ...
    ///creando tapa1
    G4double halfSizeWallXtapa = 155.*mm;
    G4double halfSizeWallYtapa = 155.*mm;
    G4double halfSizeWallZtapa = 2.5*mm;
    G4Material* W = G4NistManager::Instance()->FindOrBuildMaterial("G4_W");
    G4Box *Tapa1 = new G4Box("Tapa1", halfSizeWallXtapa, halfSizeWallYtapa, halfSizeWallZtapa);
    G4LogicalVolume *Tapa1LV = new G4LogicalVolume(Tapa1, W, "Tapa1LV", 0, 0, 0);
    G4VisAttributes* simpleTapa1VisAtt = new G4VisAttributes(G4Colour::Red());
    simpleTapa1VisAtt -> SetVisibility(true);
    Tapa1LV -> SetVisAttributes(simpleTapa1VisAtt);
    G4VPhysicalVolume *Tapa1_physical = new G4PVPlacement(0, G4ThreeVector(0.,0.,-178.*mm), "Tapa1PV", Tapa1LV, PVWorld, false, 0);

    //creando tapa2
    G4double halfSizeWall2Xtapa = 155.*mm;
    G4double halfSizeWall2Ytapa = 155.*mm;
    G4double halfSizeWall2Ztapa = 2.5*mm;
    G4Material* Cu = G4NistManager::Instance()->FindOrBuildMaterial("G4_Cu");
    G4Box *Tapa2 = new G4Box("Tapa2", halfSizeWall2Xtapa, halfSizeWall2Ytapa, halfSizeWallZtapa);
    G4LogicalVolume *Tapa2LV = new G4LogicalVolume(Tapa2, Cu, "Tapa2LV", 0, 0, 0);
    G4VisAttributes* simpleTapa2VisAtt = new G4VisAttributes(G4Colour::Magenta());
    simpleTapa2VisAtt -> SetVisibility(true);
    Tapa2LV -> SetVisAttributes(simpleTapa2VisAtt);
    G4VPhysicalVolume *Tapa2_physical = new G4PVPlacement(0,  G4ThreeVector(0.,0.,-181.*mm), "Tapa2PV", Tapa2LV, PVWorld, false, 0);
////////////////////////////////////////////////////////
*/
